...
var expectedHoldings = map[string][]string{
	"2025-12-05": {"AA", "AEM", "ALL", "APH", "AS", "AU", "BG", "CIB", "CLS", "CRDO", "DB", "DDS", "EXPD", "EXPE", "FIX", "FNV", "FOXA", "FUTU", "GFI", "HOOD", "ILMN", "ISRG", "JHX", "KGC", "LITE", "LOGI", "LVS", "MDB", "MNST", "MS", "MU", "NBIX", "NEM", "NVDA", "ONON", "RDDT", "RGLD", "SCCO", "SNDK", "STX", "TCOM", "TIMB", "TROW", "TRV", "UHS", "UI", "VALE", "VRT", "WDC", "ZTO"},
	"2025-12-12": {"AEM", "AER", "ALL", "APH", "AS", "AU", "BG", "BHP", "CIB", "CLS", "COHR", "CRDO", "DDS", "DY", "EXPD", "EXPE", "FIVE", "FIX", "FOXA", "GFI", "GM", "HOOD", "ILMN", "ISRG", "KGC", "LITE", "LOGI", "LVS", "MDB", "MNST", "MRVL", "MS", "MU", "NBIX", "NEM", "NVDA", "ONON", "RDDT", "RGLD", "RNR", "SNDK", "STRL", "TCOM", "TIGO", "TRV", "UHS", "UI", "WDC", "ZTO"},
	...
	"2025-12-26": {"AA", "AEM", "AER", "APH", "AS", "CIB", "CIEN", "CLS", "COHR", "CRDO", "CVE", "DDS", "DY", "EL", "EXPD", "EXPE", "FIVE", "FIX", "FOXA", "GM", "HOOD", "IAG", "ILMN", "IVZ", "KGC", "LITE", "LOGI", "MDB", "MNST", "MU", "NBIX", "ONON", "PAAS", "PSX", "RDDT", "RNR", "SCCO", "SNDK", "STRL", "STX", "SU", "TCOM", "TIMB", "TRMB", "UBS", "UHS", "UI", "WDC", "ZTO"},
